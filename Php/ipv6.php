...
<div id="geral"><!-- Pagina Geral -->	
	...
	<form name="IPv6" method="post" action="ipv6.php"><!-- Form Localizar, inserido aqui devido espaços que cria no IE -->
...
?>
	...
	if(isset($_POST['BtCalc'])){	
		...
		$CxQueryTabX = $_POST['CxQueryTab'];
		$EdOct[1] = $_POST['EdOct1'];
		$EdOct[2] = $_POST['EdOct2'];
		$EdOct[3] = $_POST['EdOct3'];
		$EdOct[4] = $_POST['EdOct4'];
		$EdOct[5] = $_POST['EdOct5'];
		$EdOct[6] = $_POST['EdOct6'];
		$EdOct[7] = $_POST['EdOct7'];
		$EdOct[8] = $_POST['EdOct8'];
		$EdMask = $_POST['EdMask'];
		
		
		//$EndAbreviado = $ObjFuncao->AbreviarIPv6($EdOct1, $EdOct2, $EdOct3, $EdOct4, $EdOct5, $EdOct6, $EdOct7, $EdOct8);
		$EndAbreviado = $ObjFuncao->AbreviaIPv6(	$_POST['EdOct1'], 
													$_POST['EdOct2'], 
													$_POST['EdOct3'],
													$_POST['EdOct4'],
													$_POST['EdOct5'],
	...
	?>
				...
				<tr><td>
					<table class="TAB_ConteudoInt" width=100% align="center" valign="top"> 
						...
						<tr>
							<td width="5%" colspan="1" height="20" align="left" valign="top">Endereço:</td>
							<td width="90%" colspan="1" height="20" align="left" valign="top">
								
								<input type="text" name="EdOct1" size="1" value="<?Php echo"$EdOct[1]";?>" >:
								<input type="text" name="EdOct2" size="1" value="<?Php echo"$EdOct[2]";?>" >:
								<input type="text" name="EdOct3" size="1" value="<?Php echo"$EdOct[3]";?>" >:
								<input type="text" name="EdOct4" size="1" value="<?Php echo"$EdOct[4]";?>" >:
								<input type="text" name="EdOct5" size="1" value="<?Php echo"$EdOct[5]";?>" >:
								<input type="text" name="EdOct6" size="1" value="<?Php echo"$EdOct[6]";?>" >:
								<input type="text" name="EdOct7" size="1" value="<?Php echo"$EdOct[7]";?>" >:
								<input type="text" name="EdOct8" size="1" value="<?Php echo"$EdOct[8]";?>" >/
								<input type="text" name="EdMask" size="1" value="<?Php echo"$EdMask";?>" >
								<input type="submit" name="BtCalc" value="Calc">
							</td>
