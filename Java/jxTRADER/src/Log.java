...
public class Log {
  ...
  // Pega data do sistema
	...
	// Crtl a inserção de titulo em GravarRelatorio.csv
	static boolean bInserirTitulo = true;
	public void fixeInserirTitulo(boolean bVar){ bInserirTitulo = bVar; }
	public boolean pegueInserirTitulo(){ return bInserirTitulo; }
	
	public boolean GravarRelatorio(String sTexto){
		
		/*
		 * Grava relatorio de parametros com resultados
		 */
		
		//String sHoje = DiaMes.format(dData);
		String sDirArq = new Definicoes().DirBak + "RelatorioAnalise.csv";
		File arquivo = new File(sDirArq);	
