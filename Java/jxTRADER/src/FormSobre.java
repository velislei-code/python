...
public class FormSobre{
    ...
    //	int iAjCol = 5;
        ...
        Formulario.setTitle("jxTrader - Sobre");                 
        ...
        */ 
        ...
        // Labels
        JLabel lblTitulo = new JLabel("jxTrader - Análise de dados Ativos");
        JLabel lblVersao = new JLabel("Versão: Demo - Prototype Release 13.04.19");
        JLabel lblBuild = new JLabel("Build id: " +objDef.sVersao+ "-jx1");
        
        JLabel lblCorp = new JLabel("Copyright mta (c)2018-2019, all rights reserveds");
