    ...
    for (int h = 0; h < height; h++)
    {
        for (int w = 0; w < width; w++)
        {
            ...
            if (h == height - 1)
            {
                ...
                */
                sumRed = image[h][w].rgbtRed + image[h][w1].rgbtRed + image[h][w2].rgbtRed + image[h1][w].rgbtRed + image[h1][w1].rgbtRed + image[h1][w2].rgbtRed;
                mediaRed = sumRed / 6;

                sumGreen = image[h][w].rgbtGreen + image[h][w1].rgbtGreen + image[h][w2].rgbtGreen + image[h1][w].rgbtGreen + image[h1][w1].rgbtGreen + image[h1][w2].rgbtGreen;
                mediaGreen = sumGreen / 6;

                sumBlue = image[h][w].rgbtBlue + image[h][w1].rgbtBlue + image[h][w2].rgbtBlue + image[h1][w].rgbtBlue + image[h1][w1].rgbtBlue + image[h1][w2].rgbtBlue;
                mediaBlue = sumBlue / 6;
            }
            else
            {
                 ...
                 */
                sumRed = image[h][w].rgbtRed + image[h][w1].rgbtRed + image[h][w2].rgbtRed + image[h1][w].rgbtRed + image[h1][w1].rgbtRed + image[h1][w2].rgbtRed + image[h2][w].rgbtRed + image[h2][w1].rgbtRed + image[h2][w2].rgbtRed;
                mediaRed = sumRed / 9;

                sumGreen = image[h][w].rgbtGreen + image[h][w1].rgbtGreen + image[h][w2].rgbtGreen + image[h1][w].rgbtGreen + image[h1][w1].rgbtGreen + image[h1][w2].rgbtGreen + image[h2][w].rgbtGreen + image[h2][w1].rgbtGreen + image[h2][w2].rgbtGreen;
                mediaGreen = sumGreen / 9;

                sumBlue = image[h][w].rgbtBlue + image[h][w1].rgbtBlue + image[h][w2].rgbtBlue + image[h1][w].rgbtBlue + image[h1][w1].rgbtBlue + image[h1][w2].rgbtBlue + image[h2][w].rgbtBlue + image[h2][w1].rgbtBlue + image[h2][w2].rgbtBlue;
                mediaBlue = sumBlue / 9;
            }
